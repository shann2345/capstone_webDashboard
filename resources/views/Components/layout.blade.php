...
<body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <header class="flex justify-between items-center px-4 py-3 bg-white border-b border-gray-200 shadow-sm">
        ...
        <div class="user-actions" style="display: flex; align-items: center; gap: 20px;">
            <a href="{{ Route('courseCreation') }}" style="background-color: #007bff; color: white; padding: 8px 15px; border-radius: 5px; text-decoration: none; font-weight: bold; white-space: nowrap;">+ Create Courses</a>
            
            <a href="#" class="user-info flex flex-col items-center rounded-lg hover:bg-gray-100 cursor-pointer transition-colors duration-200">
    ...
    <div class="flex flex-1">
        ...
        <nav class="w-64 bg-white border-r border-gray-200 p-4 shadow-sm md:flex flex-col hidden">
            <ul class="space-y-2">
                <li><a href="{{ Route('dashboard') }}" class="block py-2 px-3 rounded-md text-gray-700 hover:bg-gray-100 font-medium transition-colors duration-150">Active Courses</a></li>
