    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="bg-white shadow-sm border-b border-gray-200">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Student Progress Tracking</h1>
                        <p class="text-gray-600 mt-1">Monitor academic performance and learning outcomes</p>
                    </div>
                    <div class="flex items-center space-x-3">
                        {{-- All Students Details Button --}}
                        <a href="{{ route('instructor.studentDetails') }}" class="inline-flex items-center px-4 py-2 border border-blue-300 text-sm font-medium rounded-md text-blue-700 bg-blue-50 hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <form method="GET" action="{{ route('instructor.studentProgress') }}">
                    <div class="flex flex-wrap items-center gap-4">
                        ...
                        <div>
                            ...
                            <select name="course_id" onchange="this.form.submit();" class="block w-64 pl-3 pr-10 py-2 text-base border border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
                        ...
                        <div>
                            ...
                            <select name="period" onchange="this.form.submit();" class="block w-48 pl-3 pr-10 py-2 text-base border border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
                        ...
                        <div>
                            ...
                            <select name="status" onchange="this.form.submit();" class="block w-48 pl-3 pr-10 py-2 text-base border border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 mt-1">{{ $overallStats['totalStudents'] }}</p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 mt-1">{{ round($overallStats['averageGrade'], 1) }}%</p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 mt-1">{{ $overallStats['performanceDistribution']['excellent'] }}</p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 mt-1">{{ $overallStats['performanceDistribution']['at-risk'] }}</p>
                        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-6">Performance Distribution</h3>
                    <div class="space-y-4">
                        @php
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-sm font-medium text-gray-700">Excellent (85%+)</span>
                            </div>
                            <div class="flex items-center space-x-2">
                                <span class="text-sm text-gray-600">{{ $distribution['excellent'] }}</span>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-sm font-medium text-gray-700">Good (75-84%)</span>
                            </div>
                            <div class="flex items-center space-x-2">
                                <span class="text-sm text-gray-600">{{ $distribution['good'] }}</span>
                                <div class="w-32 bg-gray-200 rounded-full h-2">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-sm font-medium text-gray-700">Needs Improvement (60-74%)</span>
                            </div>
                            <div class="flex items-center space-x-2">
                                <span class="text-sm text-gray-600">{{ $distribution['needs-improvement'] }}</span>
                                <div class="w-32 bg-gray-200 rounded-full h-2">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-sm font-medium text-gray-700">At Risk (<60%)</span>
                            </div>
                            <div class="flex items-center space-x-2">
                                <span class="text-sm text-gray-600">{{ $distribution['at-risk'] }}</span>
                                <div class="w-32 bg-gray-200 rounded-full h-2">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-6">Course Performance Overview</h3>
                    <div class="space-y-4">
