<x-layout>
                        ...
                        <thead class="bg-gray-50">
                            <tr>
                                <th scope="col" class="w-4 px-6 py-3">
                                    <input type="checkbox" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" id="select-all">
                                </th>
    ...
    <div id="bulk-actions-bar" class="hidden fixed bottom-4 left-1/2 transform -translate-x-1/2 bg-white border border-gray-200 rounded-lg shadow-lg px-6 py-3 z-50">
        <div class="flex items-center space-x-4">
            ...
            <button type="button" class="px-3 py-1 bg-green-600 text-white text-sm rounded hover:bg-green-700">
                Send Message
            </button>
            <button type="button" class="px-3 py-1 bg-red-600 text-white text-sm rounded hover:bg-red-700">
                Remove Students
            </button>
            <button type="button" id="clear-selection" class="px-3 py-1 bg-gray-300 text-gray-700 text-sm rounded hover:bg-gray-400">
                Clear
            </button>
        </div>
    </div>
